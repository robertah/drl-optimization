...
import numpy as np
from .genetic_functions import crossover_function, crossover_function_1, generate_population, crossover_function_2, generate_population_2, crossover_function_1_1, noise
